...
/*
 * fork to integrate jQuery deferreds to better deal with async calls to "fetch"
 * Copyright (C) 2013 Colin Stephen
 * this fork may be freely distributed under the MIT license.  
 */
...
(function(window) {
  ...
  Backbone.Pagination.Paginator = {
    ...
    loadPage: function(page) {
      ...
      var dfd = $.Deferred();
      $.when(this.fetch(this.paginationConfig.fetchOptions))
          .fail(dfd.reject)
          .done(dfd.resolve);
      return dfd.promise();
    },
